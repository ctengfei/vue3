<template>
    <commonTable v-if="isMonitor" :title="'河道水位监测数据'" :getListUrl="getListUrl" :addUrl="addUrl" :editUrl="editUrl"
        :deleteUrl="deleteUrl" :detailUrl="detailUrl" :code="'stcd'" :stType="'ZZ'" :columns="columns" :isAdd="false"
        :formColumns="formColumns" :menu="menu" @clickMonitor="clickMonitor" />
    <monitorTable v-else :monitorTitle="monitorTitle" :monitorColoums="monitorColoums" :exportUrl="exportUrl" :getDetailUrl="getDetailUrl" :stType="'ZZ'"
        :monitorCode="monitorCode" @clickBack="clickBack" />
</template>
<script setup name="riverWaterLevel">
import {
    defineFormColumns,
...
let exportUrl = '/river/export';
let getDetailUrl = '/river/listRiverWater';
