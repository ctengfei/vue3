<template>
    <commonTable v-if="isMonitor" :title="'水库水位监测数据'" :getListUrl="getListUrl" :addUrl="addUrl" :editUrl="editUrl"
        :deleteUrl="deleteUrl" :detailUrl="detailUrl" :code="'stcd'" :stType="'RR'" :columns="columns" :isAdd="false"
        :formColumns="formColumns" :menu="menu" @clickMonitor="clickMonitor" />
    <monitorTable v-else :monitorTitle="monitorTitle" :monitorColoums="monitorColoums" :exportUrl="exportUrl" :getDetailUrl="getDetailUrl" :stType="'RR'"
        :monitorCode="monitorCode" @clickBack="clickBack" />
</template>
<script setup name="reservoirLevel">
import {
    defineFormColumns,
...
let exportUrl = '/reservoir/export';
let getDetailUrl = '/reservoir/listReservoir';
