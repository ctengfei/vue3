    ...
    <div class="app-container">
            ...
            <div class="titleBottom">
                <pro-crud ref="crudRef" :index="index" v-model="form" v-model:search="serachForm" :columns="columns"
                    ...
                    :before-close="beforeClose" width="40%" @search-reset="searchReset" @submit="submit"
                    ...
                    <template #search-menu-right="{ size }">
                        ...
                        <el-button type="success" plain icon="Switch" :size="size"
                            @click="switchTable">切换组织结构</el-button>
                    </template>
...
<script setup name="personLiableTable">
...
const emit = defineEmits(['switchTable']);
let form = ref({});
const crudRef = ref();
