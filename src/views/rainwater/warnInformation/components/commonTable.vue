    ...
    <div class="app-container">
            ...
            <div class="titleBottom">
                <pro-crud ref="crudRef" :index="index" v-model="form" v-model:search="serachForm" :columns="columns"
                    ...
                    :before-close="beforeClose" width="70%" @search-reset="searchReset" @submit="submit"
...
<script setup name="warnCommonTables">
...
const props = defineProps(['title', 'getListUrl', 'addUrl', 'editUrl', 'deleteUrl', 'detailUrl', 'code', 'formColumns', 'columns', 'menu', 'isAdd']);
