            ...
            <div class="titleBottom">
                <pro-crud ref="crudRef" :index="index" v-model="form" v-model:search="serachForm" :columns="columns"
                    ...
                    <template #form-fileList>
                        <AlUpload v-model:fileList="fileList" limit="1" accept=".pdf"/>
                    </template>
...
<script setup name="planDocTable">
...
// 获取表格数据
let getTableData = () => {
    postRequest(props.getListUrl, {...serachForm.value, pageNum: pagination.pageNum,
...
const beforeOpen = defineCrudBeforeOpen((done, type, row) => {
    if (type === 'edit' || type === 'detail' ) {
        ...
        //     fileList.value = JSON.parse(res.data.attach);
        //     form.value = res.data;
